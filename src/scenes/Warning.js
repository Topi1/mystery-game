...
export class WarningStart extends Scene
{
    ...
    create ()
    {
        ...
        this.startButton.on('pointerover', () => {this.startButton.setFillStyle(0xffffff), this.startText.setTint(0xff0000), this.startText.setText("ARE YOU SURE?")})

        this.startButton.on('pointerout', () => {this.startButton.setFillStyle(0x00ff00), this.startText.setTint(0x000000), this.startText.setText("GOT IT, START THE GAME")})

        this.startText.on('pointerover', () => {this.startButton.setFillStyle(0xffffff), this.startText.setTint(0xff0000), this.startText.setText("ARE YOU SURE?")})

        this.startText.on('pointerout', () => {this.startButton.setFillStyle(0x00ff00), this.startText.setTint(0x000000), this.startText.setText("GOT IT, START THE GAME")})
