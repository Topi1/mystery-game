...
export class LoadGamePopup extends Phaser.GameObjects.Container {
    ...
    createPopup(){
        ...
        const settingsText = this.scene.add.bitmapText(0, -80, "baseFontUI", "Load Game", 32).setOrigin(0.5);
